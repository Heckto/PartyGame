...
namespace Game1.GameObjects.Graphics.PostProcessing
{
	...
	public class PixelGlitchPostProcessor : PostProcessor
	{
		...
		public PixelGlitchPostProcessor(GameContext context) : base(context)
		{
		...
		public void LoadContent(ContentManager content)
		{
			...
			Effect = content.Load<Effect>("Effects/pixelGlitch");
			...
			_verticalSizeParam.SetValue(_verticalSize);
			_horizontalOffsetParam.SetValue(_horizontalOffset);
			_screenSizeParam.SetValue(new Vector2(game_context.graphics.Viewport.Width, game_context.graphics.Viewport.Height));
		}
